export const MEGAMI_CONTRACT_ADDRESS =
...
export const ABI = [
    ...
    inputs: [
      {
        ...
        name: "fundManagerContractAddress",
        type: "address",
      },
    ],
  ...
  {
    inputs: [
      { internalType: "string", name: "newBaseTokenURI", type: "string" },
    ],
  ...
  },
  {
    inputs: [
      {
        internalType: "uint96",
        name: "newDefaultPercentageBasisPoints",
        type: "uint96",
      },
    ],
    ...
    inputs: [
      {
        ...
        name: "newDefaultRoyaltiesReceipientAddress",
        type: "address",
      },
    ],
